...
<head>
    ...
    <title>UCM</title>
    <link rel="shortcut icon" href="<%=basePath%>/Experiment4/imgs/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="<%=basePath%>/Experiment4/iconfont/iconfont.css">
    <link rel="stylesheet" href="<%=basePath%>/Experiment4/css/UCM.css">
</head>
...
<a href="login.jsp">
    <h1>
        <img src="<%=basePath%>/Experiment4/imgs/logo.png" alt="">
        <p style="color: black">UCM</p>
    </h1>
</a>
<script src="<%=basePath%>/Experiment4/js/jquery.js"></script>
<div class="lunbo">
    <div class="side" style="background-image: url('<%=basePath%>/Experiment4/imgs/banner12.jpg'););">
    </div>
    <div class="side" style="background-image: url('<%=basePath%>/Experiment4/imgs/banner22.jpg'););">
    </div>
    <div class="side" style="background-image: url('<%=basePath%>/Experiment4/imgs/banner32.jpg'););">
    </div>
    <div class="side" style="background-image: url('<%=basePath%>/Experiment4/imgs/banner42.jpg'););">
    </div>
</div>
<div class="top">
    <ul>
...
<div class="main-wraper">
    <div class="main">
        <form method="post" action="/JavaWeb_war_exploded/CheckloginServlet" id="test_form" class="form">
            <div class="title">
                <h2>欢迎登录UCM</h2>
                <h3>
                    每一天,乐在沟通。
...
<script src="<%=basePath%>/Experiment4/js/ucm.js"></script>
<script>
    function findcount(){
        var tmpHtml = ""
